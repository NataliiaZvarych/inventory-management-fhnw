...
It does not run the web application.

Run examples:
- python -m app.seedData --init-db
- python -m app.seedData --seed
- python -m app.seedData --init-db --seed
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Inventory database setup"
    )
    ...
    # --seed means: insert initial records.
    parser.add_argument(
        "--seed",
        action="store_true",
